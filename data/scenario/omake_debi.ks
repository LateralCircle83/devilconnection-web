...
[tb_start_text mode=1 ]
#贝尔芬格
哈啊～[delay speed=100]……[resetdelay]，要是本大爷能和布布一样，[r]
光靠吃东西就能补充魔力，该多好啊。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#别西卜
对了，有个人，老夫想让你认识一下。[wait time=400][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#别西卜
此处堕乐园，所用之环境与地上并无二致，[r]
管理者便是在这样的条件下，育养诸多果实。[p]
...
[tb_start_text mode=1 ]
#尼斯洛克
[font size=50]满意吗？[wait time=200][r]
这份儿童午餐的味道……[wait time=300][resetfont][p]
[_tb_end_text]

[playbgm  volume="50"  time="0"  loop="true"  storage="16_the_devil_s_power.ogg"  ]
[tb_start_text mode=1 ]
#贝尔芬格
（搞、[wait time=100]…[wait time=100]…[wait time=100]搞什么啊这家伙！？[r]
突然就把本大爷当小孩来对待了！？）[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#贝尔芬格
（本大爷可是看得一清二楚[delay speed=100]……[resetdelay]你那满腹的坏心思[delay speed=100]……[resetdelay][r]
别以为没有邪眼，就能胡思乱想！）[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#贝尔芬格
（[delay speed=100]……[resetdelay]！？竟然在心里说布布坏话？）[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#贝尔芬格
（就这货居然还能担当布布的近侍！不可原谅[delay speed=100]……[resetdelay]）[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#贝尔芬格
你、你个[delay speed=300]……[resetdelay][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#别西卜
唔姆[delay speed=100]……[resetdelay]果然，你的料理依旧如往昔般美味。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#贝尔芬格
（[delay speed=100]……[resetdelay]或许是因为本大爷太不中用，[r]
才连累布布的名声也一并受损。）[p]
[_tb_end_text]
